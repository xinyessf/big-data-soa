package com.huanyu.spark.scala.day9
...
object KafkaWordCount {
  ...
  def main(args: Array[String]): Unit = {
    val brokerList = "192.168.73.128:9092,192.168.73.128:9092,192.168.73.128:9092"

    //指定zk的地址，后期更新消费的偏移量时使用(以后可以使用Redis、MySQL来记录偏移量)
    val zkQuorum = "192.168.73.128:2181"
    ...
    val groupId = "g1"
    val topic = Map[String, Int]("huanyu" -> 1)

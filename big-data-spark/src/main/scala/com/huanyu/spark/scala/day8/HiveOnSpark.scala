...
object HiveOnSpark {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val sql3: DataFrame = spark.sql("load data local inpath 'e:/wordcount/spark/20200512030001.csv' into table t_dm_goip_black_tactics  partition(day='20200509')")
    //查表
    val result12: DataFrame = spark.sql("select * from t_dm_goip_black_tactics where day='20200509'")

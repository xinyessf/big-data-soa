...
public class CityRestController {
    ...
    public List<City> findByDescriptionAndScore(@RequestParam(value = "description", required = false) String description,
    ...
    public List<City> findByDescriptionOrScore(@RequestParam(value = "description", required = false) String description,
                                               @RequestParam(value = "score", required = false) Integer score) {
    ...
    public List<City> findByDescription(@RequestParam(value = "description", required = false) String description) {
    ...
    public List<City> findByDescriptionNot(@RequestParam(value = "description", required = false) String description) {
    ...
    public List<City> findByDescriptionLike(@RequestParam(value = "description", required = false) String description) {
